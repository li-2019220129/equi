<template>
  <div>
    <div class="drawer-header">
      <div class="drawer-header title">设备审批流程{{ title }}</div>
    ...
    <div class="drawer-form-title" style="margin-top: 100px">审批节点配置</div>
...
import { saveFlow, flowUpdate } from "@/api/system";
export default {
  name: "FlowEditor",
  components: {
    FlowNode,
  ...
  watch: {
    ...
    editNodes: {
      ...
      handler(val) {
        ...
        if (val && val.length > 0) {
          this.nodes = [...val];
          console.log(this.nodes,'212121212121')
        }
      },
    },
  },
  methods: {
    changeNode(user, index) {
      ...
      console.log(this.nodes,'22222222')
      ...
      console.log(this.nodes,'1111111')
    },
    addNodeLast() {
      this.nodes = [
        ...this.nodes,
    ...
    save() {
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          console.log(this.nodes,'9999991111')
          const params = {
            ...this.form,
