  ...
  <div>
    <div class="drawer-form">
      ...
      >
        ...
        <el-form-item>
          <label slot="label" style="font-weight: 400">外送事由</label>
      ...
      <div class="equipment-message">
        <div class="equipment-header">
          <div class="equipment-header-left">
            <div class="drawer-form-title">外送设备信息</div>
          </div>
        </div>
        <leadal-table
...
import { detailAuditTakeout, findDeviceByTakeoutId } from "@/api/equipment";
export default {
  ...
  methods: {
    async getData() {
      ...
      const res = await detailAuditTakeout(params);
      const editObj = res.data.takeoutView;
      Object.assign(this.applyForm, editObj);

      this.findDevice(findDeviceByTakeoutId(params));
