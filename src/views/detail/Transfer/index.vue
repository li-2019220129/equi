<template>
  <div>
    <div class="drawer-header">
      <div class="drawer-header title">设备移交申请详情</div>
...
<script>
import TranfserMessage from "./TranfserMessage.vue";
...
import { batchTakeoutAgree, batchTakeoutDisAgree } from "@/api/equipment";
export default {
  name: "BorrowDrawer",
  components: {
    TranfserMessage,
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.ruleForm.agree
        ? this.agreeOrDisagree(batchTakeoutAgree(params))
        : this.agreeOrDisagree(batchTakeoutDisAgree(params));
    },
