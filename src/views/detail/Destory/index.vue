<template>
  <div>
    <div class="drawer-header">
      <div class="drawer-header title">设备销毁申请详情</div>
...
<script>
import DestoryMessage from "./DestoryMessage.vue";
...
import { batchDestoryAgree, batchDestoryDisAgree } from "@/api/equipment";
export default {
  name: "BorrowDrawer",
  components: {
    DestoryMessage,
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.ruleForm.agree
        ? this.agreeOrDisagree(batchDestoryAgree(params))
        : this.agreeOrDisagree(batchDestoryDisAgree(params));
    },
